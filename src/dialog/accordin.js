...
import { setCar1,setFirstCarAuthendication } from '../slice/slice';
import './accordin.scss';
export default function SelectVariants1() {
  ...
  const handleChange = (event) => {
    setAge(event.target.value);
      ...
      dispatch(setFirstCarAuthendication(true))
    };
...
<InputLabel id="demo-simple-select-standard-label"><img width={'14%'} src={require("./icons/icon-1.jpg")}/>Maruti suzuki</InputLabel>
        <Select 
